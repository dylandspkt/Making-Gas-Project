...
void thoigian()
{
  ...
  //    print2so(tm.Month);
  //    GLCD.print("/");
  //    print2so(tmYearToCalendar(tm.Year));
...
void loop()
{
  ...
  //pt1 = pt100_1.temperature(RNOMINAL, RREF);
  // pt2 = 99.7; //pt100_2.temperature(RNOMINAL, RREF) * 0.96515679443;
  //GLCD.print("t1:"); GLCD.print(pt1, 1); GLCD.print("C");
  noInterrupts();
  GLCD.CursorTo(12, 1);
  GLCD.print("t1:"); 
  GLCD.print(t1, 1);
  ...
  // t3 = 20.5; //(mcp3204.readADC(0) * 0.02597977778 - 20) * 0.96864111498;
  // h = mcp3204.readADC(1) * 0.02442002442;
